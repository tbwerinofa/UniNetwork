...
{
    public partial class EventTypeMap : InsightEntityTypeConfiguration<EventType>
    {
        public EventTypeMap()
        {
        ...
        public override void Configure(EntityTypeBuilder<EventType> modelBuilder)
        {
           ...
           .WithMany(u => u.UpdatedEventTypes)
           .OnDelete(DeleteBehavior.Restrict);
